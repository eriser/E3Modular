...
namespace e3 {
    ...
    {
    public:
        TableComponent( const std::string& tagName );

        virtual void addColumn( const std::string& name, int id, int width );
        virtual void loadData( XmlElement* xml );
        ...
        virtual int getActiveRowNumber() const;
    ...
    protected:
        ...
        std::string tagName_;                 // xml tag name that represents the items in the list
